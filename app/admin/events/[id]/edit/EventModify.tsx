        ...
        <main className="flex flex-col bg-sidebar flex-1 min-w-0 min-h-fit ml-4 md:ml-6 mr-4 my-8 rounded-2xl px-3 md:px-7 py-7 gap-10">
            ...
            <Form action={triggerConfirmation} className="flex flex-col xs:px-4 sm:px-7 pb-7 lg:px-20 xl:px-50 pt-7 gap-10">
                ...
                <section className="w-full flex items-center justify-center">
                    <button 
                        type="submit"
                        className={`${saveInProgress ? "opacity-70 bg-sidebar-hover! cursor-not-allowed!" : "hover:bg-sidebar-hover"} mt-10 flex flex-row justify-center gap-3 font-outfit font-medium w-100 p-3.5 rounded-2xl cursor-pointer whitespace-nowrap hover:bg-sidebar-hover bg-sidebar-logout`}
                    >   
