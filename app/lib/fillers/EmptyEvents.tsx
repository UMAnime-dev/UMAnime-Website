    ...
    return (
        <section className="mt-20 px-6 sm:px-10 md:px-15 lg:px-[clamp(60px,9.25vw,130px)] xl:px-35 2xl:px-50">
            ...
            <div className="flex flex-col text-center mb-5 mt-17 items-center">
                ...
                <p className="mt-5 font-outfit font-normal italic">
                    {"The upcoming events schedule is empty??? ✨"}
                </p>
            </div>
            <div className="flex flex-col items-center w-full px-10 md:px-60 min-h-full text-center mb-17 md:mb-14">
                ...
                <p className="mt-3 font-outfit font-normal">
                    We are working hard to finalize our list of upcoming events!!
                </p>
                <p className="mt-1 font-outfit font-normal">
                    Thanks for being patient - we cannot wait to show you what we have in store this year! 🩷🩷
                </p>
                <p className="mt-10 font-outfit font-normal">
                    Come back later when we are done, hehe!
                </p>
                <p className="mt-10 font-outfit font-normal">
                    - Yukari Haruno
                </p>
