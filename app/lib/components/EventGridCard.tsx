    ...
    return (
        ...
        >
            ...
            <section className="w-full h-50">
                <Image src={`${process.env.NEXT_PUBLIC_EVENT_DIRECTORY}${eventData.photourl}`} width={400} height={300} style={{ width: '400', height: '300' }} className={`w-full h-full object-cover object-[${eventData.photooffset}]`} alt={eventData.id}/>
            </section>
            <h1
