...
export default function EventListCard({eventData}: {eventData: Event}) {
    return (
        <main
            className="relative gap-2 w-full md:max-w-none max-w-120 min-h-40 overflow-x-hidden bg-eventCard rounded-xl flex md:flex-row flex-col items-center py-5 md:py-0 shadow-black shadow-2xl transition hover:scale-[1.02] hover:shadow-2xl/100 hover:shadow-foreground/25"
        >
